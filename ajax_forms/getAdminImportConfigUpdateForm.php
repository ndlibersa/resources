					...
					<div id='importConfigColumnsLeft'>
						<div id='ic-left-column'>
							...
							<div id='resource_alias'>
								...
								?>
								<p><a href='#'>+ Add another alias set</a></p>
							</div>
							...
							<div id='resource_note'>
								<?php
									if(count($configuration["note"]) > 0) {
										foreach($configuration["note"] as $note) {
											echo "<p><span class='ic-label'>Note</span><span><input class='ic-column' value='".$note."' /></span></p><p><span><select class='ic-dropdown'>";
										...
										echo "<p><span class='ic-label'>Note</span><span><input class='ic-column' value='' /></span></p><p><span><select class='ic-dropdown'";
										foreach($noteTypeArray as $noteType) {
											echo "<option value='" . $noteType['noteTypeID'] . "'>" . $noteType['shortName'] . "</option>";
										}
										echo "</select></span></p>";
								...
								?>
								<p><a href='#'>+ Add another note set</a></p>
							</div>
						</div>
					</div>
