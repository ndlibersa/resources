		...
		<td>
			...
			<td>
                ...
                <tr class='newPaymentTR'>
                    ...
                    <?php if ($enhancedCostFlag){ ?>
                        <td style='vertical-align:top;text-align:left;background:white;'>
                        <input type='text' value = '' style='width:60px;' class='changeDefaultWhite changeInput subscriptionStartDate' />
                        </td>
                        <td style='vertical-align:top;text-align:left;background:white;'>
                        <input type='text' value = '' style='width:60px;' class='changeDefaultWhite changeInput subscriptionEndDate' />
                        </td>
                    <?php } ?>
                    <td style='vertical-align:top;text-align:left;background:white;'>
                    ...
                    <?php if ($enhancedCostFlag){ ?>
                        <td style='vertical-align:top;text-align:left;background:white;'>
                        <input type='text' value = '' style='width:50px;' class='changeDefaultWhite changeInput invoice' />
                        </td>
                    <?php } ?>
				...
				if (count($paymentArray) > 0){
                    ...
                    ?>
                        ...
                        <?php if ($enhancedCostFlag){ ?>
                            <td style='vertical-align:top;text-align:left;'>
                            <input type='text' value = '<?php echo $payment['subscriptionStartDate']; ?>' style='width:60px;' class='changeInput subscriptionStartDate' />
                            </td>
                            <td style='vertical-align:top;text-align:left;'>
                            <input type='text' value = '<?php echo $payment['subscriptionEndDate']; ?>' style='width:60px;' class='changeInput subscriptionEndDate' />
                            </td>
                        <?php } ?>
						<td style='vertical-align:top;text-align:left;'>
                        ...
                        <?php if ($enhancedCostFlag){ ?>
                            <td style='vertical-align:top;text-align:left;'>
                            <input type='text' value = '<?php echo $payment['invoice']; ?>' style='width:50px;' class='changeInput invoice' />
                            </td>
                        <?php } ?>
