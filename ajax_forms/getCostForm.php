<?php
	...
	$resource = new Resource(new NamedArguments(array('primaryKey' => $resourceID)));
		...
		if ($enhancedCostFlag){
			$baseWidth += 688;
			$numCols += 9; // year, sub start, sub end, cost details, invoice num
		}
?>
		...
		<td>
			...
			<td>
				...
				<tr>
					...
					<?php if ($enhancedCostFlag){ ?>
					<td style='vertical-align:top;text-align:left;font-weight:bold;'>Fund Code</td>
					<td style='vertical-align:top;text-align:left;font-weight:bold;'>Tax Excl.</td>
					<td style='vertical-align:top;text-align:left;font-weight:bold;'>Tax Rate</td>
					<td style='vertical-align:top;text-align:left;font-weight:bold;'>Tax Incl.</td>
					<?php } ?>
		...
		<?php if ($enhancedCostFlag){ ?>
		<td style='vertical-align:top;text-align:left;background:white;'>
		<input type='text' value='' style='width:60px;' class='changeDefaultWhite changeInput fundCode' />
    <td style='vertical-align:top;text-align:left;background:white;'>
...
?>
		...
		<?php if ($enhancedCostFlag){ ?>
    <td style='vertical-align:top;text-align:left;'>
		<input type='text' value='<?php echo $payment['fundCode']; ?>' style='width:60px;' class='changeInput fundCode' />
		</td>
    <td style='vertical-align:top;text-align:left;'>
    ...
    <td style='vertical-align:top;text-align:left;'>
		<input type='text' value='<?php echo $payment['taxRate']; ?>' style='width:60px;' class='changeInput taxRate' />
		</td>
    <td style='vertical-align:top;text-align:left;'>
