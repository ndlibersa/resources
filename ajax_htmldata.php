...
switch ($_GET['action']) {
	...
	case 'getSearchResources':
		...
		if ($_POST['resourceID']) $whereAdd[] = "R.resourceID = '" . $_POST['resourceID'] . "'";
		...
		if (count($resourceArray) == 0){
			...
			<th><table class='noBorderTable' style='width:100%'><tr><td>Creator</td><td style='width:10px;'><a href='javascript:setOrder("U.loginID","asc");'><img src='images/arrowup.gif' border=0></a></td><td style='width:10px;'><a href='javascript:setOrder("U.loginID","desc");'><img src='images/arrowdown.gif' border=0></a></td></tr></table></th>
