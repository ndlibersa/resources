...
function generateIssueHTML($issue,$associatedEntities=null) {
	...
	if (!$issue->dateClosed) {
		...
		<a class=\"thickbox closeIssueBtn\" href=\"ajax_forms.php?action=getNewDowntimeForm&resourceID={$GLOBALS['resourceID']}&issueID={$issue->issueID}&height=200&width=390&modal=true\">downtime</a>";
	}
	$html .= "
	  	<dl>
	  		<dt>Date reported:</dt> 
