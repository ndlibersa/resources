...
$(function(){
  ...
  $(".taxRate").change(function() {
	...
	$(".addPayment").live('click', function () {
		...
		var fCode     = $('.newPaymentTable').children().children().children().children('.fundCode').val();
		...
		if ((pAmount == '' || pAmount == null) && (fName == '' || fName == null)){
			...
			$('.newPaymentTable').children().children().children().children('.fundCode').val('');
...
function submitCostForm(){
	...
	fundCodeList ='';
	$(".fundCode").each(function(id) {
	      fundCodeList += $(this).val() + ":::";
	}); 
